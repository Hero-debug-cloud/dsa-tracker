...
export default function LeaderboardPage() {
  ...
  return (
    <div className="container mx-auto py-6 sm:py-12 px-4 max-w-6xl">
              ...
              {loading ? (
                ...
                leaderboard.map((entry, index) => (
                  <div
                    key={entry.user}
                    className={cn(
                      "border-b p-4 hover:bg-muted/50 transition-colors last:border-b-0",
                      getRankStyles(index),
                    )}
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            {index === 0 && (
                              <span className="text-[10px] uppercase font-bold text-yellow-600 dark:text-yellow-400 ml-1">
                                Leader
                              </span>
                            )}
                          </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-3">
                      <div className="text-center">
                        ...
                        <div className="font-mono">{entry.easy_solved}</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xs text-amber-600 dark:text-amber-500 font-medium">
                          Medium
                        </div>
                        <div className="font-mono">{entry.medium_solved}</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xs text-rose-600 dark:text-rose-500 font-medium">
                          Hard
                        </div>
                        <div className="font-mono">{entry.hard_solved}</div>
                      </div>
                    </div>
                  </div>
                ))
              ) : (
                <div className="p-8 text-center py-16 text-muted-foreground">
